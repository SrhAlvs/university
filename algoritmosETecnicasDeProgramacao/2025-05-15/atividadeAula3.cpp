...
int main(){
	...
	Faca um programa que leia o nome e a funcao de um trabalhador. 
	Caso ele seja vendedor, leia o total de vendas e imprima o total ganho
	(sabendo que ele ganha 1000 reais + 2% de comissao sobre as vendas). 
	Caso seja balconista ou gerente, leia o total de horas trabalhadas e imprima seu salario, 
	sabendo que seu salario eh de 10 reais por hora.*/
	string cargo, nome; 
