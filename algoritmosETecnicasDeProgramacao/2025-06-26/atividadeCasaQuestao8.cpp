...
int main() {
	...
	- Verificar se a mediana é maior ou igual a metade do maior valor da lista,
	...
	if(mediana >= numMaior/2.) { //2.0: dividir um int por um float transforma o int em float, as divisões com números ímpares darão certo
